...
public class ActionGenerator {
	...
	public ArrayList<GraphNode> currentState = null;
	...
	public void execute(String[] args){
		...
		// Check if the input value mathch the parameter types,
	...
	// Helper function that checks if String value is matches the type
	...
	// Every time, it calls next, update the current State
	public void next() {
	...
	// Check if all the steps has been finished
